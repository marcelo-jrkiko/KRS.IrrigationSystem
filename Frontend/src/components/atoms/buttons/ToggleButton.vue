...
<script lang="ts">
import { isString, isObject, has, get, translate, px } from '@/core/Utils/ObjectUtils'
import { StyleValue } from 'vue'

const DEFAULT_COLOR_CHECKED = '#2d8c2d'
const DEFAULT_COLOR_UNCHECKED = '#0B1A00'
const DEFAULT_LABEL_CHECKED = 'on'
const DEFAULT_LABEL_UNCHECKED = 'off'
const DEFAULT_SWITCH_COLOR = '#FFF3E5'
const DEFAULT_SWITCH_UNCHECKED_COLOR = '#FFF3E5'
...
export default {
  ...
  computed: {
    ...
    switchColorUnchecked() {
      return get(this.switchColor, 'unchecked', DEFAULT_SWITCH_UNCHECKED_COLOR)
    },
  },
  watch: {
    value(value) {
